...
int main()
{
	...
	for (int i = 0; i < 8; i++)
	{
		...
		treeMenu[i].setColor(sf::Color::Red);
	...
	treeMenu[0].setColor(sf::Color::Cyan);
	...
	for (int i = 0; i < 6; i++)
	{
		...
		textMenu[i].setColor(sf::Color::Red);
			...
			if (menu)
			{
				...
				if (sf::Keyboard::isKeyPressed(sf::Keyboard::Up)&&up)
				{
					...
					for (int i = 1; i < 6; i++)
					{
						...
						{
							textMenu[i].setColor(sf::Color::Green);
						}
						else
						{
							textMenu[i].setColor(sf::Color::Red);
			...
			else if (tree)
			{
				...
				if (sf::Keyboard::isKeyPressed(sf::Keyboard::Up) && upTree)
				{
					...
					for (int i = 1; i < 6; i++)
					{
						...
						{
							treeMenu[i].setColor(sf::Color::Green);
						}
						else
						{
							treeMenu[i].setColor(sf::Color::Red);
